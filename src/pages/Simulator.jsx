...
function App() {
  ...
  // 감축 계수
  const reductionFactor = [2019, 2020, 2021, 2022, 2023, 2024, 2025];
  ...
  const tempData = [
    ...
    { Capacity: 6810, A: 15.67, B: 17.13, C: 18.22, D: 19.31, E: 21.5 },
    { Capacity: 6880, A: 15.57, B: 17.01, C: 18.1, D: 19.19, E: 21.36 },
    { Capacity: 6940, A: 15.49, B: 16.93, C: 18.01, D: 19.09, E: 21.25 },
    { Capacity: 7010, A: 15.39, B: 16.82, C: 17.89, D: 18.96, E: 21.11 },
    { Capacity: 7070, A: 15.31, B: 16.73, C: 17.8, D: 18.87, E: 21.0 },
    { Capacity: 7140, A: 15.21, B: 16.63, C: 17.69, D: 18.75, E: 20.87 },
    { Capacity: 7200, A: 15.14, B: 16.54, C: 17.6, D: 18.66, E: 20.77 },
    { Capacity: 7270, A: 15.04, B: 16.44, C: 17.49, D: 18.54, E: 20.64 },
    { Capacity: 7330, A: 14.96, B: 16.36, C: 17.4, D: 18.44, E: 20.53 },
    { Capacity: 7400, A: 14.88, B: 16.26, C: 17.3, D: 18.34, E: 20.41 },
    { Capacity: 7460, A: 14.8, B: 16.18, C: 17.21, D: 18.24, E: 20.31 },
    { Capacity: 7530, A: 14.71, B: 16.08, C: 17.11, D: 18.14, E: 20.19 },
    { Capacity: 7590, A: 14.65, B: 16.01, C: 17.03, D: 18.05, E: 20.1 },
  ...
  const execute = () => {
    axios
      .post("http://118.129.145.21:1882/cii_test", data)
      .then((res) => {
