          ...
          <div className="bg-white  border border-black px-6 py-8 rounded-lg">
            ...
            <div className="mb-4">
              ...
              <div className={'flex mb-2'}>
                ...
                <select name="ship_type" value={data.ship_type} onChange={dataHandler}
              ...
              <div className={'flex mb-2'}>
                ...
                <input type="text" name="summer_load_dwt" value={data.summer_load_dwt} onChange={dataHandler}
                       className="w-1/2 p-2  border rounded text-right"/>
              </div>

              <div className={'flex mb-2'}>
                <label className={'w-1/2 my-auto'}>용적톤수 (GT)</label>
                <input type="text" name="gross_tonnage" value={data.gross_tonnage} onChange={dataHandler}
            ...
            <div className="mb-4">
              ...
              <div className="flex mb-2">
                ...
                <input type="text" name="diesel_gas_oil_consumption" value={data.fuels.diesel_gas_oil_consumption}
                       onChange={dataHandler} placeholder="0" className="text-right w-1/2 p-2 border rounded"
              ...
              <div className="flex mb-2">
                ...
                <input type="text" name="light_fuel_oil_consumption" value={data.fuels.light_fuel_oil_consumption}
                       onChange={dataHandler} placeholder="0" className="text-right w-1/2 p-2 border rounded"
              ...
              <div className="flex mb-2">
                ...
                <input type="text" name="heavy_fuel_oil_consumption" value={data.fuels.heavy_fuel_oil_consumption}
                       onChange={dataHandler} placeholder="0" className="text-right w-1/2 p-2 border rounded"
              ...
              <div className="flex mb-2">
                ...
                <input type="text" name="lpg_propane_consumption" value={data.fuels.lpg_propane_consumption}
                       onChange={dataHandler} placeholder="0" className="text-right w-1/2 p-2 border rounded"
              ...
              <div className="flex mb-2">
                ...
                <input type="text" name="lpg_butane_consumption" value={data.fuels.lpg_butane_consumption}
                       onChange={dataHandler} placeholder="0" className="text-right w-1/2 p-2 border rounded"
              ...
              <div className="flex mb-2">
                ...
                <input type="text" name="lng_consumption" value={data.fuels.lng_consumption} onChange={dataHandler}
                       placeholder="0" className="text-right w-1/2 p-2 border rounded" disabled={!fuelConsumption.lng}/>
              </div>
              <div className="flex mb-2">
                ...
                <input type="text" name="methanol_consumption" value={data.fuels.methanol_consumption}
                       onChange={dataHandler} placeholder="0" className="text-right w-1/2 p-2 border rounded"
              ...
              <div className="flex mb-2">
                ...
                <input type="text" name="ethanol_consumption" value={data.fuels.ethanol_consumption}
                       onChange={dataHandler} placeholder="0" className="text-right w-1/2 p-2 border rounded"
            ...
            <div className="mb-4">
              ...
              <div className={'flex mb-2'}>
                ...
                <input type="text" name="total_distance_travelled" value={data.total_distance_travelled}
                       onChange={dataHandler} className="w-1/2 p-2 mb-2 border rounded text-right"/>
              </div>
            </div>

            <div className={'flex mt-5'}>
              <button onClick={execute} className="w-1/2 mx-auto text-xl bg-gray-800 text-white p-2 rounded">실 행
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white px-6 py-8 rounded-lg border border-black">
            ...
            <div className="mb-4">
              ...
              <div className="mb-2">
                ...
                <input type="text" value={ciiResult.required_cii ? ciiResult.required_cii : 0}
                       className="w-full p-2 mb-2 border rounded text-center" readOnly/>
              </div>
              <div className="mb-2">
                <label className="block">Attained CII</label>
                <input type="text" value={ciiResult.attained_cii ? ciiResult.attained_cii : 0}
                       className="w-full p-2 mb-2 border rounded text-center" readOnly/>
              </div>
              ...
              <div>
                ...
                <div className="w-full mb-2 border rounded grid grid-cols-12 text-center">
                  <div
                    className={`col-span-4 ${ciiResult.cii_grade === "A" ? "bg-green-500 text-white font-black" : "bg-green-100"} py-3 border`}>
                    A
                  </div>
                  <div
                    className={`col-span-8 ${ciiResult.cii_grade === "A" ? "bg-green-500 text-white font-black" : ""} py-3 border`}>
                    {ciiResult.rate.A}
                  </div>
                  <div
                    className={`col-span-4 ${ciiResult.cii_grade === "B" ? "bg-blue-500 text-white font-black" : "bg-blue-100"} py-3 border`}>
                    B
                  </div>
                  <div
                    className={`col-span-8 ${ciiResult.cii_grade === "B" ? "bg-blue-500 text-white font-black" : ""} py-3 border`}>
                    {ciiResult.rate.B}
                  </div>
                  <div
                    className={`col-span-4 ${ciiResult.cii_grade === "C" ? "bg-amber-500 text-white font-black" : "bg-amber-100"} py-3 border`}>
                    C
                  </div>
                  <div
                    className={`col-span-8 ${ciiResult.cii_grade === "C" ? "bg-amber-500 text-white font-black" : ""} py-3 border`}>
                    {ciiResult.required_cii}
                  </div>
                  <div
                    className={`col-span-4 ${ciiResult.cii_grade === "D" ? "bg-rose-300 text-white font-black" : "bg-rose-100"} py-3 border`}>
                    D
                  </div>
                  <div
                    className={`col-span-8 ${ciiResult.cii_grade === "D" ? "bg-rose-300 text-white font-black" : ""} py-3 border`}>
                    {ciiResult.rate.D}
                  </div>
                  <div
                  ...
                  <div
                    className={`col-span-8 ${ciiResult.cii_grade === "E" ? "bg-red-500 text-white font-black" : ""} py-3 border`}>
                    {ciiResult.rate.E}
                  </div>
                </div>
              </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <XAxis dataKey="Capacity"
                           label={{value: 'Capacity', position: 'insideBottom', offset: -5, dx: -300, dy: 10}}/>
                    {/* Y축 범위 설정 */}
